...
/// <summary>
/// Credit: git-amend
/// https://www.youtube.com/watch?v=XBbt8juGrH4
/// </summary>
...
public static class ColliderExtensions
{
    ...
    public static bool GetPenetrationsInLater(this Collider source, LayerMask layerMask, out Vector3 totalCorrection)
    {
    ...
    public static bool ComputePenetration(this Collider source, Collider target, out Vector3 direction, out float distance)
    {
        ...
        return Physics.ComputePenetration(source, source.transform.position, source.transform.rotation,
